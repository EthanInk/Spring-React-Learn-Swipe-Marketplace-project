...
export default function Register() {
  ...
  async function loginOnRegister({ email, name, surname, password }) {
    await authContext
      .login(email, password)
      .then(() => {
        const params = {msg: `Regestered and logged in successfully! Welcome to swipe ${name} ${surname}.`};
        navigate({
          pathname: '/welcome',
      ...
      .catch(() => {
        setErrorMessage(
          "Failed to login once registered. Please try logging in again."
        );
      });
  }
